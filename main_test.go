...
import (
	...
	main "github.com/SemmiDev/kanbanapp"
...
var _ = os.Setenv("DATABASE_URL", "postgres://root:secret@localhost:5432/kampusmerdeka")
...
var _ = Describe("TestAPIHandler", Ordered, func() {
	...
	BeforeAll(func() {
		...
		apiServer = main.RunHttpServer(db, apiServer)
	})
...
var _ = Describe("TestWebHandler", Ordered, func() {
	...
	BeforeAll(func() {
		...
		clientHandler = main.RunHttpServer(db, clientHandler)
